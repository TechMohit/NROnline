...
public class BrandsListAdapter extends RecyclerView.Adapter {
    ...
    private OnItemClickListener<BrandsModel> clickListener;

    public BrandsListAdapter(ArrayList<BrandsModel> data, Activity activity, OnItemClickListener<BrandsModel> clickListener) {
        this.dataSet = data;
